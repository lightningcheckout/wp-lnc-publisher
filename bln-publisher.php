 ...
 * Description:       Plugin for WordPress to accept instant Bitcoin Lightning payments directly to your Lightning Checkout account.
 * Version:           1.9.0
 * License:           GPL-3.0
...
define('BLN_PUBLISHER_VERSION', '1.9.0');
